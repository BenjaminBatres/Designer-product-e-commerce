          ...
          <div className="max-w-400 mx-auto">
            <div className="flex">
              ...
              <div className="w-full xmd:w-[80%]">
                ...
                <div
                  className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 relative ${filteredByRating.length === 0 && activeTab === "Ratings" ? "justify-center" : "justify-start"}`}
                >
                  {isLoading ? (
